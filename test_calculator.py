...
class TestCalculator(unittest.TestCase):
    ...
    def test_log_invalid_argument(self):
        with self.assertRaises(ValueError):
            calculator.logarithm(1, 10)  # base 1 is invalid
        with self.assertRaises(ValueError):
            calculator.logarithm(-2, 10)  # base < 0
        with self.assertRaises(ValueError):
            calculator.logarithm(2, -10)  # log of negative number
    ...
    def test_logarithm(self):
        ...
        self.assertAlmostEqual(calculator.logarithm(4, 16), 2.0)
